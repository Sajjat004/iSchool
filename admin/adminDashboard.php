          ...
          <table class="table">
            ...
            <tbody>
              ...
              echo '<tr>';
                ...
                echo '<td>'.$row['stuEmail'].'</td>';
                echo '<td>'.$row['orderDate'].'</td>';
                echo '<td>'.$row['amount'].'</td>';
                echo '<td>
                <form action = "" method = "POST" class = "d-inline">
                <input type = "hidden" name = "id" value = '.$row["orderId"].'>
                <button type="submit" class="btn btn-primary" name="delete" value="Delete"><i class="far fa-trash-alt"></i></button></td>
                </form>
             </tr>';
              }
             ?>
...
<?php
  if (isset($_REQUEST['delete'])) {
    ...
    echo $orderId;
    echo ' ';
    $sql = "DELETE FROM courseorder WHERE orderId = '$orderId'";
