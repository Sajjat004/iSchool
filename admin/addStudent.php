...
<?php
  ...
  if(isset($_REQUEST['newStuSubmitBtn'])) {
    if (($_REQUEST['stuName'] == "") || ($_REQUEST['stuEmail'] == "") || ($_REQUEST['stuPass'] == "") || ($_REQUEST['stuOcc'] == "")) {
      ...
      $sql = "INSERT INTO student (stuName, stuEmail, stuPass, stuOcc) VALUES('$stuName', '$stuEmail', '$stuPass', '$stuOcc')";
      if ($conn->query($sql) == TRUE) {
        $msg = '<span class="alert alert-success col-sm-6 ml-5 mt-2">Student Added Successfully</span>';
      } else {
        $msg = '<span class="alert alert-danger col-sm-6 ml-5 mt-2">Unable to Add Student</span>';
      }
      ...
      <div class="col-sm-6 mt-5 mx-3 jumbotron">
        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" name="stuOcc" id="stuOcc" class="form-control">
          </div>
