...
<?php
  ...
  if(isset($_REQUEST['courseSubmitBtn'])) {
    if (($_REQUEST['courseName'] == "") || ($_REQUEST['courseDesc'] == "") || ($_REQUEST['courseAuthor'] == "") || ($_REQUEST['courseDuration'] == "") || ($_REQUEST['coursePrice'] == "") || ($_REQUEST['courseOriginalPrice'] == "")) {
      ...
      $sql = "INSERT INTO course (courseName, courseDesc, courseAuthor, courseImg, courseDuration, coursePrice, courseOriginalPrice) VALUES('$courseName', '$courseDesc', '$courseAuthor', '$imgFolder', '$courseDuration', '$coursePrice', '$courseOriginalPrice')";
      if ($conn->query($sql) == TRUE) {
        $msg = '<span class="alert alert-success col-sm-6 ml-5 mt-2">Course Added Successfully</span>';
      } else {
        $msg = '<span class="alert alert-danger col-sm-6 ml-5 mt-2">Unable to Added Course</span>';
      }
      ...
      <div class="col-sm-6 mt-5 mx-3 jumbotron">
        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <textarea name="courseDesc" id="courseDesc" rows="2" class="form-control"></textarea>
          </div>
          <div class="form-group">
            <label for="courseAuthor">Course Author</label>
            <input type="text" name="courseAuthor" id="courseAuthor" class="form-control">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="courseOriginalPrice" id="courseOriginalPrice" class="form-control">
          </div>
          <div class="form-group">
